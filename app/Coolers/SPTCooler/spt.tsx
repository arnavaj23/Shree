...
export function Sptexport() {
  const list = [
    ...
    {
      title: "image2",
      img: "https://m.media-amazon.com/images/I/71g43JUIb-L._SL1500_.jpg",
      price: "$3.00",
      link: "Coolers/Hawells",
    },
    {
      title: "image3",
      img: "https://m.media-amazon.com/images/I/6184nNImj8L._SL1500_.jpg",
      price: "$10.00",
      link: "/Kindia",
    },
  ];
  const [messages, setMessages] = useState([
    {
      text: "Hi I am Mr.Pclub Seller, you are viewing Havells section",
      isUser: false,
    },
  ]);
          ...
          <div className="px-6 pt-0 pb-8  sm:mx-auto sm:rounded-sm sm:px-10">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-4">
              ...
              <p className="text-gray-800">
                ...
                Pump stop working in 1 day of delivery . I purchase this item
                with customer rating and brand orient has but as it is internal
                defect I'm returning . Please don't select this item
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-4">
              ...
              <p className="text-gray-800">
                Looks wise cooler is good, slim, but ot makes noise, i bought
                this cooler for lesser noise but my old kenstar cooler is better
                than this, the worst thing is it has water indicator which is
                useless, we can not see water level properly ffom indicator and
                we fill the water from tap directly then water overflows, my
                whole room was filled eith water, and we have to open 6 screw to
                open the side panel, of you want to fill the water directly from
                bucket, every time u have to open and close 6 screw, it takes
                time.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-4">
              ...
              <p className="text-gray-800">
                This is just the perfect size of cooler that I needed. With 50L
                capacity of water it doesn't need to be filled everyday. Takes
                less space in the room and works no less than an air
                conditioner. My room becomes cool and relaxing. Consumes less
                electricity as well. The wheels make it easily portable. Easy to
                clean and maintain with such an affordable price.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className=" px-10 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto  sm:rounded-lg sm:px-10">
            <div className="mx-auto grid w-full max-w-6xl gap-2">
              <header className="font-bold text-3xl font-serif text-center">
                Havells Altima 70L Desert Air Cooler for home |5 Leaf Fan{" "}
                <br></br> | Powerful Air Delivery | 3 Side High Density
                Honeycomb Pads <br></br>|Everlast Pump |Ice Chamber | Heavy Duty
                (Dark Blue)
              </header>
              {/* <p className="p-2"></p> */}
              <div className="border-b-4 border-black h-6"></div>
