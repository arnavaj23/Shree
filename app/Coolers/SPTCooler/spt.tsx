      ...
      >
        <div className="flex-col absolute top-16 left-10  px-10 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
          ...
          <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            ...
            <p className="text-gray-800">
              Looks wise cooler is good, slim, but ot makes noise, i bought this
              cooler for lesser noise but my old kenstar cooler is better than
              this, the worst thing is it has water indicator which is useless,
              we can not see water level properly ffom indicator and we fill the
              water from tap directly then water overflows, my whole room was
              filled eith water, and we have to open 6 screw to open the side
              panel, of you want to fill the water directly from bucket, every
              time u have to open and close 6 screw, it takes time.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 mb-4">
            ...
            <p className="text-gray-800">
              ...
              less space in the room and works no less than an air conditioner.
              My room becomes cool and relaxing. Consumes less electricity as
              well. The wheels make it easily portable. Easy to clean and
              maintain with such an affordable price.
            </p>
          </div>
        </div>
