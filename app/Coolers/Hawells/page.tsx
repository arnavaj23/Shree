  ...
  return (
    <div className="flex">
      ...
      >
        ...
        <div className="flex-col justify-between absolute top-16 left-10  md:max-w-l sm:max-w-sm lg:max-w-xl px-10 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-w sm:rounded-lg sm:px-10">
        ...
        <div className="flex justify-between">
          <div className=" absolute md:max-w-xl sm:max-w-sm lg:max-w-2xl right-10 top-20">
            <div className=" px-10 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto  sm:rounded-lg sm:px-10">
              <div className="mx-auto grid w-full max-w-6xl gap-2">
                <header className="font-bold text-3xl font-serif text-center">
                  SPINEHEAL MATTRESS Box Type Soft Cotton Filled Bed Mattress,
                  Firm Gadda for Floor, Bed, Travelling, Multipurpose, Light
                  Weight, King Size Mattress (72X48, Double Size)
                </header>
                {/* <p className="p-2"></p> */}
                <div className="border-b-4 border-black h-6"></div>
              ...
              <div className="p-3">
                ...
                <div className="list">
                  <li>
                    ...
                    technology of the desert air cooler offers superior air
                    delivery of 3650 m3/ hour. The blades make sure that there
                    is low operating noise.{" "}
                  </li>
                  <br></br>
                  <li>
                    Long air throw of 59 feet: This air cooler for rooms, halls
                    and restaurants comes with a long air throw of 59 feet to
                  ...
                  <li>
                    ...
                    cord winder that makes for a tidier storage when the cooler
                    is not in use.{" "}
                  </li>
                  <br></br>
                  <li>
                    Fully collapsible louvres: Louvres of the air cooler are
                    100% collapsible. Shut the louvres down and keep the dust
                    and insects from entering it when the cooler is not in use.
                  </li>
                  <br></br>
                  <li>
                    Compatible with inverter: For areas that face frequent power
                    outages, this inverter compatible air cooler is the perfect
                    solution for Indian summers, for it gives you consistent
                    cooling even during power cuts.{" "}
                  </li>
                  <br></br>
                  <li>
                    12-month warranty for absolute peace of mind: The air cooler
                    comes protected against manufacturing defects with a
              ...
              <div className="text-xl space-x-4">
                <div className="list-outside">
                  ...
                  <div className="text-sm">
                    As a 4th-year B.Tech student at IIT Kanpur, I've cherished
                    my time on campus, but it's time for me to move on. Before I
                    depart, I'm offering a reliable air cooler for sale. This
                    air cooler has been meticulously maintained and has provided
                    me with comfort during hot summer days. If you're in search
                    of an efficient cooling solution, look no further. Get in
                    touch to make this air cooler yours and beat the heat in
                    style!
                  </div>
                </div>
              </div>
